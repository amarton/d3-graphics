...
d3.queue()
    .defer(d3.csv, 'temp_data_0.csv')
    .defer(d3.csv, 'temp_data_10.csv')
    .defer(d3.csv, 'temp_data_20.csv')
    .defer(d3.csv, 'temp_data_30.csv')
    .defer(d3.csv, 'temp_data_40.csv')
    .defer(d3.csv, 'temp_data_50.csv')
    .defer(d3.csv, 'temp_data_60.csv')
    .defer(d3.csv, 'temp_data_70.csv')
    .defer(d3.csv, 'temp_data_80.csv')
    .defer(d3.csv, 'temp_data_90.csv')
    .defer(d3.csv, 'temp_data_100.csv')
